...
function renderizarEtapaI() {
  page3.innerHTML = "";
  page3.innerHTML += `<div class="etapa etapa--inicial">
...
function renderizarEtapaII() {
  page3.innerHTML = "";
  page3.innerHTML += `<div class="etapa etapa--perguntas">
            <h2>Crie suas perguntas</h2>
        </div>`;
  const etapa = document.querySelector(".etapa--perguntas");
  for (var i = 0; i < numeroPerguntas; i++) {
    etapa.innerHTML += `<div class="bloco">
            <div class="sub-bloco">
                <h3>Pergunta ${
                  i + 1
                }</h3><ion-icon onclick="selecionarPergunta(this)" name="create-outline"></ion-icon>
            </div>
            <div class="sub-bloco">
...
function selecionarPergunta(perguntaClicada) {
  const perguntaSelecionada = document.querySelector(
    ".etapa--perguntas .selecionado"
  );
...
function renderizarEtapaIII() {
  page3.innerHTML = "";
  page3.innerHTML += `<div class="etapa etapa--niveis">
  ...
  for (var i = 0; i < numeroNiveis; i++) {
    etapa.innerHTML += `<div class="bloco">
            <div class="sub-bloco">
                <h3>Nível ${
                  i + 1
                }</h3><ion-icon onclick="selecionarNivel(this)" name="create-outline"></ion-icon>
            </div>
            <div class="sub-bloco">
                <div class="forms forms--nome">
                    <h3>Nível ${i + 1}</h3>
...
function renderizarEtapaIV() {
  body.innerHTML = `<header><h1 onclick="carregarPagina1()">BuzzQuizz</h1></header>
        <main class="page3"></main>`;
  page3 = document.querySelector(".page3");

  page3.innerHTML += `<div class="etapa etapa--final">
